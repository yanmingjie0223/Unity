...
public class RedistInstall {
    ...
    static void AddDefineSymbols() {
		NamedBuildTarget nbt = NamedBuildTarget.FromBuildTargetGroup(EditorUserBuildSettings.selectedBuildTargetGroup);
        string currentDefines = PlayerSettings.GetScriptingDefineSymbols(nbt);
        HashSet<string> defines = new(currentDefines.Split(';')) {
			"STEAMWORKS_NET"
		};
